...
#define ORIGINAL_FILE_NAME "UE4Editor-RunebergVRPlugin.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME EarthquakeVR
#define DEPRECATED_FORGAME DEPRECATED
#define RUNEBERGVRPLUGIN_API DLLEXPORT
